...
public class RoomServiceImpl implements RoomService {
    ...
    private static final Map<RoomStatus, Set<RoomStatus>> ALLOWED_TRANSITIONS = Map.of(
            RoomStatus.AVAILABLE, EnumSet.of(RoomStatus.RESERVED, RoomStatus.MAINTENANCE, RoomStatus.OUT_OF_SERVICE),
            RoomStatus.RESERVED, EnumSet.of(RoomStatus.OCCUPIED, RoomStatus.AVAILABLE, RoomStatus.MAINTENANCE),
            RoomStatus.OCCUPIED, EnumSet.of(RoomStatus.AVAILABLE, RoomStatus.MAINTENANCE),
    ...
    public RoomResponse createRoom(RoomRequest request) {
        ...
        validateDuplicateRoomNumber(request.getRoomNumber(), null);
    ...
    public Page<RoomResponse> getAllRooms(Pageable pageable) {
        log.debug("Fetching rooms page: {}, size: {}", pageable.getPageNumber(), pageable.getPageSize());
    ...
    public RoomResponse updateRoom(Long id, RoomRequest request) {
        ...
        validateDuplicateRoomNumber(request.getRoomNumber(), id);
        validatePricing(request.getPricePerNight(), request.getDiscountedPrice());
    ...
    public void deleteRoom(Long id) {
        ...
        if (!bookingRoomRepository.findByRoomId(id).isEmpty()) {
    ...
    public Page<RoomResponse> searchRooms(
        ...
        log.debug("Searching rooms with filters roomNumber={}, type={}, status={}, minCapacity={}, minPrice={}, maxPrice={}",
                roomNumber, roomType, status, minCapacity, minPrice, maxPrice);
    ...
    private void validateDuplicateRoomNumber(String roomNumber, Long currentRoomId) {
        boolean duplicate = currentRoomId == null
                ? roomRepository.existsByRoomNumber(roomNumber)
                : roomRepository.existsByRoomNumberAndIdNot(roomNumber, currentRoomId);
