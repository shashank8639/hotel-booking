...
public class JwtService implements TokenProvider {
    ...
    /**
     * Reads the {@code roles} claim embedded at token creation time.
     */
    @SuppressWarnings("unchecked")
    public List<String> extractRoles(String token) {
        Object claim = extractAllClaims(token).get(SecurityConstants.ROLES_CLAIM);
    ...
    /**
     * Reads the {@code type} claim — {@code ACCESS} vs {@code REFRESH}.
     */
