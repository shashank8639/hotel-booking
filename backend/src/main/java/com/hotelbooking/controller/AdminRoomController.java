...
public class AdminRoomController {
    ...
    @Operation(summary = "Patch room description only")
    @PatchMapping("/{id}/description")
    public ResponseEntity<RoomResponse> patchDescription(
            @PathVariable Long id,
            @Valid @RequestBody RoomDescriptionPatchRequest request
    ) {
        return ResponseEntity.ok(roomService.patchDescription(id, request));
    }

    @Operation(summary = "Soft-delete a room (catalog hide; history retained)")
    @DeleteMapping("/{id}")
