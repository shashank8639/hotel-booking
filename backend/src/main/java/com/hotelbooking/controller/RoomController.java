...
public class RoomController {
    ...
    @Operation(summary = "List rooms with pagination and sorting")
    @GetMapping
    ...
    @Operation(summary = "Search rooms with combined filters")
    @GetMapping("/search")
    public ResponseEntity<Page<RoomResponse>> searchRooms(
        ...
        return ResponseEntity.ok(roomService.searchRooms(
                roomNumber, roomType, status, minCapacity, minPrice, maxPrice, pageable
        ));
    }
