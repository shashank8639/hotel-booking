...
public class GuestController {
    ...
    @Operation(summary = "Get all guests with pagination and sorting")
    @GetMapping
    ...
    @Operation(summary = "Search guest by email")
    ...
    @Operation(summary = "Search guest by phone number")
    ...
    @Operation(summary = "Search guests by full or partial name")
